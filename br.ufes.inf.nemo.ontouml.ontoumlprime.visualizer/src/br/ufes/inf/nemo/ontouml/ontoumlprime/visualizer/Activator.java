package br.ufes.inf.nemo.ontouml.ontoumlprime.visualizer;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "br.ufes.inf.nemo.ontouml.ontoumlprime.visualizer"; //$NON-NLS-1$
